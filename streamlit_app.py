...
if nav == 'Go to homepage':
    ...
    st.image('https://thumbs.dreamstime.com/z/ernest-hemingway-vector-portrait-ernest-hemingway-hand-drawn-portrait-ernest-hemingway-vector-face-drawing-ernest-hemingway-114208112.jpg', width = 50)
